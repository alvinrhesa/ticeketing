...
class kunci extends CI_Controller {
	...
	public function simpan_kunci()
	{
        ...
        array('required' => 'kepada harus diisi'));
		$this->form_validation->set_rules('tempat', 'Tempat', 'trim|required',
        array('required' => 'tempat harus diisi'));
		$this->form_validation->set_rules('lampiran', 'Lampiran', 'trim|required',
        array('required' => 'lampiran harus diisi'));
		$this->form_validation->set_rules('tempatt', 'tempat', 'trim|required',
        array('required' => 'tempat harus diisi'));
		$this->form_validation->set_rules('acara', 'Acara', 'trim|required',
        array('required' => 'acara harus diisi'));
		$this->form_validation->set_rules('deskripsi', 'Deskripsi', 'trim|required',
        array('required' => 'Deskripsi harus diisi'));
		// $this->form_validation->set_rules('id_sifat', 'Sifat', 'trim|required',
        // array('required' => 'Sifat harus diisi'));
