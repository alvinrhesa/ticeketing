...
$("#brow").change(function() {
    if(this.value != ''){
        //Get Data
        $.ajax({
            url: "<?php echo base_url() ?>index.php/peminjaman_user/searchNumberKey",
            type: "POST",
            data: "Id="+this.value,
            cache: false,
        ...
        $.ajax({
            url: "<?php echo base_url() ?>index.php/peminjaman_user/searchOperator",
            type: "POST",
            data: "Id="+this.value,
            cache: false,
            success: function(data){
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php endif; ?>
                    <?php endif; ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php/peminjaman_user/submit" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Kode Transaksi</label>
                                        <input name='id_peminjaman' id="id_peminjaman" type="text" class="form-control" value="<?php echo $kode ?>" readonly="readonly" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="brow" id="brow">
                                            <option value="brow">Pilih Id Kunci</option>
